...
impl Info {
    ...
    ///
    /// If [super::Config::public_ip] was set, this is what will be returned
    ...
    /// but if [super::Config::server_mode] was set to true, then whether or not this node is firewalled
    /// won't matter.
